...
```sh
gcc -std=gnu23 -DNDEBUG=1 -Wall -Wextra -Wpedantic -O3 -flto=auto -march=native -mtune=native -o dbs26 src/args.c src/dbs26.c src/nproc.c src/solver.c src/task.c src/timer.c src/worker.c
```
...
```sh
clang -std=gnu23 -DNDEBUG=1 -Wall -Wextra -Wpedantic -Weverything -O3 -flto=full -fuse-ld=lld -march=native -mtune=native -o dbs26 src/args.c src/dbs26.c src/nproc.c src/solver.c src/task.c src/timer.c src/worker.c
```
...
```pwsh
cl /TC /std:clatest /experimental:c11atomics /DNDEBUG=1 /Wall /O2 /Oi /GL /GF /Zo- /favor:AMD64 /arch:AVX2 /MT /Fe: dbs26.exe src/args.c src/dbs26.c src/nproc.c src/solver.c src/task.c src/timer.c src/worker.c
```
